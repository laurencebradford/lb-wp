...
// Thumbnail sizes
add_image_size( 'wpbs-featured', 780, 350, true);
add_image_size( 'wpbs-featured-home', 600, 350, true);
add_image_size( 'wpbs-featured-carousel', 970, 400, true);
add_image_size( 'bones-thumb-300', 300, 300, true);
add_image_size( 'lb-thumb', 150, 150, true);
...
function wp_bootstrap_register_sidebars() {
    register_sidebar(array(
      'id' => 'sidebar1',
      'name' => 'Main Sidebar',
      'description' => 'Used on every page BUT the single post.',
    ...
    register_sidebar(array(
      'id' => 'sidebar2',
      'name' => 'Single Sidebar',
      'description' => 'Used only on the single template.',
      'before_widget' => '<div id="%1$s" class="widget %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h4 class="widgettitle">',
      'after_title' => '</h4>',
    ...
    register_sidebar(array(
      'id' => 'footer1',
      'name' => 'Footer 1',
      'description' => 'top part of footer',
...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
        wp_register_style( 'main', get_template_directory_uri() . '/assets/css/screen.css', array(), '1.0', 'all' );
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script( 'bootstrap', 
      get_template_directory_uri() . '/assets/bower_components/bootstrap-sass-official/assets/javascripts/bootstrap.min.js', 
      array('jquery'), 
      '1.2' );
